...
function Cart({ products, updateQuantity, removeProduct, totalPrice }) {
  ...
  return (
    <div className="cart">
			<h2 align="center" style={{ color: 'rgb(255, 26, 26)', fontWeight:'bold', fontSize:'20px'}}>Your shopping cart</h2>
